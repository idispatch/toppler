...
typedef struct _menusystem {
    ...
    struct _menusystem * parent; /* the current parent, or NULL */
...
/* create a new menu */
_menusystem *new_menu_system(const char *title, menuopt_callback_proc pr, int molen = 0,
        int ystart = 25);
